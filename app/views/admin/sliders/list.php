...
<div class="container">
    ...
    <div class="float-right mr-4">
        <a class="btn btn-success  mb-3" 
            href="<?=BASE_URL?>/admin/sliders/create">
    ...
    <table class="table  table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <img src="<?=BASE_URL?>/public/backend/image/sliders/<?=$item->image?>" alt="" style="max-width:100%; max-height: 100%;" >
                </td>
                <td><?=$item->created_at?></td>
                <td>
                    <a class="btn mr-2 btn-outline-warning rounded-circle m-btn m-btn--icon btn-sm m-btn--icon-only m-btn--pill m-btn--air" 
                    href="<?=BASE_URL?>/admin/sliders/edit/<?=$item->id?>">
                    ...
                    href="<?=BASE_URL?>/admin/sliders/delete/<?=$item->id?>">
