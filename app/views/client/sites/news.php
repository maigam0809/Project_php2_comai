...
<li class="breadcrumb-item active cl-control" aria-current="page">Tin tức</li>
    ...
    <div class="container col-12">
        ...
        <div class="row ">
            ...
            <img src="<?=BASE_URL?>/public/backend/image/new/<?=$item->image?>" alt="" style="width: 100%; height: 200px;">
               
            </div>
            <div class="col-xl-9 col-lg-8 col-md-8 col-sm-8">
            <a href="<?= BASE_URL ?>/new_detail/<?=$item->id?>"><h4 class="text-title"><?=$item->name?></h4></a>
